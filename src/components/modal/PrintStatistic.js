...
class PrintStatistic extends Component {
           ...
           <div className="container-fluid">
            ...
            <section>
                ...
                <header>
                 ...
                 <ComponentPrintStat ref={el => (this.componentRef = el)} />
                </div>
                </div>
...
PrintStatistic.propTypes={
  ...
  export default connect(mapStateToProps, {getListAudit})(PrintStatistic)
